...
public class BatallonTest {
    ...
    public void setUp() {
        ...
        batallon1.registrarMision("906", "2024/6/6", "Montenegro", 3, 2);
        batallon1.registrarVehiculo(2, 80, "ABCD123", "Modelo X", 2020, 20000, 1, 0);
        vehiculo1 = batallon1.getListaVehiculos().get(0);
        LOG.info("Instancias de Batallon creadas");
    }

    @Test
    public void testAgregarMisionesBatallon() {
        LOG.info("Iniciando Prueba de Agregar una misión al Batallón");
        ...
        assertEquals(tamanioInicial + 1, tamanioFinal, "No se registró la misión en la lista de misiones");
        LOG.info("Fin de la prueba de Agregar una misión al Batallón");
    }
    @Test
